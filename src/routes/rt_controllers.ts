...
import {hasEmptys as hasEmptysCargos, procesarDatos} from "../middlewares/cargos/crearMDW";
import ctrl_ingresos from "../controllers/ctrl_ingresos";
import { hasEmptys as hasEmptysIngresos } from "../middlewares/ingresos/crearMdw";
const route = Router();
...
//Gastos
route.post("/gasto", [hasEmptysCargos, procesarDatos],ctrl_gastos.crear);
route.put("/gasto", ctrl_gastos.actualizar); //No funciona aun
route.delete("/gasto", ctrl_gastos.eliminar);

//Ingresos
route.post("/ingreso", [hasEmptysIngresos], ctrl_ingresos.crear_ingreso);
